                ...
                <div className="flex items-center gap-2">
                  ...
                  {onOpenCamera && (
                    <Button
                      ...
                      className="border-emerald-500/40 hover:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 font-bold font-mono text-xs gap-1.5 h-8 px-3 cursor-pointer"
                    >
                      <Camera className="h-3.5 w-3.5" />
                      <span>Bedside Sensor</span>
                    </Button>
                  )}
